...
public class CharacterNameManager
{
    ...
    public static string GetName(CharacterGender gender = CharacterGender.Unisex)
    {
        int count = 0;
        while (count <= 20)
        {
            ...
            if (gender == CharacterGender.Unisex)
            {
                ...
                case "FirstNames":
                    if (reader.ReadToDescendant("Name"))
                    {
                        do
                        {
                            ...
                            CharacterGender gender = string.IsNullOrEmpty(genderAttribute) ? CharacterGender.Unisex :
